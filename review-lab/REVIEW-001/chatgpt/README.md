# REVIEW-001 — Chatgpt workspace

This is the independent reviewer workspace for **chatgpt** in REVIEW-001.

## Identification

- **Repository:** `froekjaer/Mission-Platform`
- **Branch:** `review/review-001-chatgpt`
- **Workspace:** `review-lab/REVIEW-001/chatgpt/`
